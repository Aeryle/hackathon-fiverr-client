      ...
      <form
        ...
        <div className="flex flex-col justify-center w-full">
          <div className="flex flex-col my-2">
            ...
            />
            <p className="text-white text-sm ">{errors.email?.type === 'required' && 'Please enter your email'}</p>
          </div>
          <div className="flex flex-col my-2">
            <input
              className="h-8 w-64 rounded-lg text-black mx-auto px-2"
            ...
            />
            <p className="text-white text-sm ">{errors.password?.type === 'required' && 'Please enter a password'}</p>
          </div>
          <div className="flex flex-col text-center mt-2 mb-8">
            ...
            <p className="text-xs">
              Forgot your password? ? Click <span className="text-red-400">here</span>
            </p>
          </div>
